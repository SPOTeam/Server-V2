...
class CleanupPostOnMemberWithdrawnTest {
  ...
  CleanupPostOnMemberWithdrawn handler;

  @BeforeEach
  void setUp() {
    handler = new CleanupPostOnMemberWithdrawn(postLikeRepository, commentRepository, postRepository);
  }
