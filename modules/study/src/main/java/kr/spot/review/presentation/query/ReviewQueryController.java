...
public class ReviewQueryController {
  ...
  @Operation(summary = "스터디 회고록 목록 조회", description = "특정 스터디의 회고록 목록을 조회합니다. 커서 기반 페이지네이션을 지원합니다.")
  @GetMapping
  public ResponseEntity<ApiResponse<GetReviewListResponse>> getReviewList(
    ...
    GetReviewListResponse response = getReviewService.getReviewList(studyId, memberId, cursor,
        size);
