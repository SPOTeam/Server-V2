...
public class StudyViewFlushJob {

  private static final String KEY_PREFIX = "view:study:";
  private static final String KEY_PATTERN = KEY_PREFIX + "*";
  private static final String LOCK_KEY = "lock:study-view-flush";

  private final StringRedisTemplate redis;
  private final StudyViewFlusher studyViewFlusher;
  ...
  private void executeBatch() {
    ...
    log.info("StudyViewFlushJob 완료: 성공 {}건, 실패 {}건, {}ms",
  ...
  private void processKey(byte[] keyBytes, BatchResult result) {
    ...
    try {
      ...
      Long studyId = extractStudyIdFromKey(key);
      if (studyId == null) {
  ...
  private Long extractStudyIdFromKey(String key) {
    try {
