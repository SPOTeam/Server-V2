...
public class ScheduleFixture {
  ...
  public static Schedule schedule() {
    return Schedule.of(ID, STUDY_ID, CREATOR_ID, TITLE, LOCATION_MEMO, START_AT, END_AT);
  }

  public static Schedule schedule(Long id, Long studyId) {
    return Schedule.of(id, studyId, CREATOR_ID, TITLE, LOCATION_MEMO, START_AT, END_AT);
  }
