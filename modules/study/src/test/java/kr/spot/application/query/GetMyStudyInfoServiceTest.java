...
class GetMyStudyInfoServiceTest {
    ...
    class GetMyStudyOverview {
        ...
        void should_return_first_page_with_next_page() {
            ...
            // when
            GetStudyOverviewResponse response = getMyStudyInfoService.getMyStudyOverview(viewerId, status, null,
                    pageSize);
        ...
        void should_return_next_page_with_cursor() {
            ...
            // when
            GetStudyOverviewResponse response = getMyStudyInfoService.getMyStudyOverview(viewerId, status, cursor,
                    pageSize);
    ...
    class GetMyPreferredRegionStudies {
        ...
        void should_find_studies_in_all_preferred_regions_when_no_filter() {
            ...
            given(studyQueryRepository.findMyPreferredRegionStudies(any(), any(), any(), any(), any(), anyInt(),
                    eq(preferredRegions)))
                    .willReturn(studies);

            // when
            GetStudyOverviewResponse response = getMyStudyInfoService.getMyPreferredRegionStudies(
                    viewerId, RecruitingStatus.RECRUITING, FeeCategory.ABOVE_50K, Collections.emptyList(), SortBy.HITS,
