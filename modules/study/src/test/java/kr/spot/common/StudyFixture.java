...
public class StudyFixture {
  ...
  public static Study study() {
    return Study.of(ID, LEADER_ID, NAME, MAX_MEMBERS, Fee.of(HAS_FEE, FEE_AMOUNT), IMAGE_URL,
        DESCRIPTION);
  }
  ...
  public static List<Study> createStudies(int count) {
    return LongStream.range(0, count)
        .mapToObj(i -> {
          ...
          return Study.of(studyId, LEADER_ID, NAME + " " + studyId, MAX_MEMBERS,
              Fee.of(HAS_FEE, FEE_AMOUNT), IMAGE_URL, DESCRIPTION);
        })
        .toList();
  }
}
